...
public class TestCidrTrie {
  ...
  public void testOrder() {
    ...
    final AbstractBinaryTrie<String> trie = new AbstractBinaryTrie<>();
  ...
  public void testMapInterface() {
    ...
    assertEquals(
        ...
        trie.values().toString());

    assertEquals("[0.0.0.0/1, 0.0.0.0/3, 128.0.0.0/1, 224.0.0.0/3]", trie.keySet().toString());
    assertEquals("[0.0.0.0/1=depth 1 s: 0.0.0.0/1, 0.0.0.0/3=depth 3 s: 0.0.0.0/3, "
        + "128.0.0.0/1=depth 1 t: 128.0.0.0/1, 224.0.0.0/3=depth 3 t: 224.0.0.0/3]",
        trie.entrySet().toString());
    ...
    // assertEquals("[depth 1 s: 0.0.0.0/1]", trie.suffixValues(s1).toString());
    assertEquals("[depth 1 s: 0.0.0.0/1, depth 3 s: 0.0.0.0/3]", trie.suffixValues(s3).toString());
    // assertEquals("[depth 1 t: 128.0.0.0/1]", trie.suffixValues(t1).toString());
    assertEquals("[depth 1 t: 128.0.0.0/1, depth 3 t: 224.0.0.0/3]",
        trie.suffixValues(t3).toString());

    assertEquals("null=null", trie.getRoot().toString());


    assertEquals("0.0.0.0/1", trie.getRoot().left.getKey().toString());

    assertEquals("0.0.0.0/2", trie.getRoot().left.left.getKey().toString());

    assertEquals("0.0.0.0/3", trie.getRoot().left.left.left.getKey().toString());

    assertEquals("128.0.0.0/1", trie.getRoot().right.getKey().toString());

    assertEquals("192.0.0.0/2", trie.getRoot().right.right.getKey().toString());

    assertEquals("224.0.0.0/3", trie.getRoot().right.right.right.getKey().toString());


    assertEquals("depth 1 s: 0.0.0.0/1", trie.getRoot().left.getValue().toString());

    assertEquals(null, trie.getRoot().left.left.getValue());

    assertEquals("depth 3 s: 0.0.0.0/3", trie.getRoot().left.left.left.getValue().toString());

    assertEquals("depth 1 t: 128.0.0.0/1", trie.getRoot().right.getValue().toString());

    assertEquals(null, trie.getRoot().right.right.getValue());

    assertEquals("depth 3 t: 224.0.0.0/3", trie.getRoot().right.right.right.getValue().toString());
    ...
    assertEquals("{0.0.0.0/1=depth 1 s: 0.0.0.0/1, 0.0.0.0/3=depth 3 s: 0.0.0.0/3, "
        + "128.0.0.0/1=depth 1 t: 128.0.0.0/1}", trie.toString());

    assertEquals("[depth 1 s: 0.0.0.0/1, depth 3 s: 0.0.0.0/3, depth 1 t: 128.0.0.0/1]",
        trie.values().toString());

    assertEquals("[0.0.0.0/1, 0.0.0.0/3, 128.0.0.0/1]", trie.keySet().toString());
    ...
    assertEquals(null, trie.getRoot().right.right);
